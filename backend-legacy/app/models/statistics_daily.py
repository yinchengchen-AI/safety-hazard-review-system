...
from sqlalchemy import Column, Date, DateTime, Integer, String, ForeignKey, UniqueConstraint
...
class StatisticsDaily(Base):
    ...
    __table_args__ = (
        UniqueConstraint("stat_date", "enterprise_id", "batch_id", "inspector_id", name="uix_stats_daily"),
    )
